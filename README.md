...
Relation between Freight and Prices
...
Strong Performance: 4.21 average rating indicates customer satisfaction
Growth Trend: Steady revenue increase from Oct 2016 to Oct 2017
Geographic Concentration: Sao Paulo dominates revenue generation
Payment Preference: Credit cards are the most popular payment method
Product Leaders: Bed & bath products consistently top sales
Customer Quality: 48.84% of customers give 5-star ratings
How to Use
Select desired filters (Customer State, Year, Month, Payment Type)
Navigate between Home and Analytics sections
Hover over charts for detailed information
Use year/month selectors to view specific time periods
Analyze trends and patterns across different dimensions
Performance Metrics
Avg Rating: 4.21/5
Total Revenue: 6.45M
...
Project created using Python data cleaning, SQL queries, and exploratory data analysis techniques. Dashobard link: https://drive.google.com/file/d/1e_XPK6TfzYacvHQaVWEgqmi43S6VAeQN/view?usp=sharing
